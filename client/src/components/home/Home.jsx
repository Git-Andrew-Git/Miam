...
import illustration3 from "../../assets/delivery-location.svg";
import illustration2 from "../../assets/deliveryman-with-pizza.svg";
        ...
        <div className={classes.delivery}>
          ...
          <div className={classes.deliveryInfos}>
            ...
            <div className={classes.deliveryInfo}>
              ...
              <h3>He is very friendly and social</h3>
            </div>
            <div className={classes.deliveryInfo}>
              <img src={illustration3} alt="" className={classes.thirdImg} />
              <h3>And always fulfills your order requirements</h3>
            </div>
          </div>
        </div>
        <Foods />
